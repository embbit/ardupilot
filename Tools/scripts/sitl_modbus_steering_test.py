...
def run_rc_buttons():
    ...
    try:
        ...
        if not any("cal@limit" in t or "cal done at limit" in t for t in events):
            ...
            return 1
        if not any("spd-follow" in t or " v10i" in t or " v10h" in t or " v10g" in t or " v10f" in t or " v10e" in t or " v10d" in t or " v10c" in t or " v10b" in t or " v10a" in t or " v10" in t or " v9" in t or "v8" in t
